        ...
        <div className="card border-0 rounded-0 p-3 depth">
            ...
            <div className="col-lg-6">
                ...
                <div className="buttons mt-4 d-flex flex-column flex-lg-row gap-3">
                    <Link to = "#" className="btn btn-lg btn-dark btn-ecomm px-5 py-3">Buy Now</Link>
                    <Link to = "#" className="btn btn-lg btn-outline-dark btn-ecomm px-5 py-3">View Details</Link>
                </div>
                </div>
            </div>
            </div>
